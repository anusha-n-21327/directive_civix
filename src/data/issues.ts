...
export const sampleIssues: Issue[] = [
  ...
  },
  {
    ...
    description: "A large tree has fallen across Elm Street, completely blocking traffic.",
    location: "Elm Street, between 2nd and 3rd Ave",
    status: "Pending",
    reportedAt: "2023-10-28T07:30:00Z",
    priority: "High",
    citizenName: "Sunita Gupta",
    issueArea: "Roads",
    category: "Emergency",
    imageUrl: "https://picsum.photos/seed/fallentree/800/600",
  },
  {
    id: "10",
    citizenId: "CZ-44556",
    title: "Flickering Traffic Light",
    description: "The traffic light at the corner of Maple and Pine is flickering and causing confusion.",
    location: "Intersection of Maple and Pine",
    status: "In Progress",
    reportedAt: "2023-10-27T18:00:00Z",
    priority: "Medium",
    citizenName: "Vijay Patil",
    issueArea: "Road Safety",
    category: "Infrastructure",
    imageUrl: "https://picsum.photos/seed/trafficlight/800/600",
  },
  {
    id: "11",
    citizenId: "CZ-77889",
    title: "Overgrown Bushes on Sidewalk",
    description: "Bushes from a public park are overgrown and blocking the sidewalk, forcing pedestrians onto the street.",
    location: "Sidewalk next to Liberty Park",
    status: "Resolved",
    reportedAt: "2023-10-15T12:00:00Z",
    priority: "Low",
    citizenName: "Ananya Desai",
    issueArea: "Parks & Recreation",
    category: "Maintenance",
    imageUrl: "https://picsum.photos/seed/bushes/800/600",
  },
  {
    id: "12",
    citizenId: "CZ-99001",
    title: "Leaking Fire Hydrant",
    description: "A fire hydrant is continuously leaking water, creating a large puddle on the road.",
    location: "Corner of 5th St and Broadway",
    status: "Pending",
    reportedAt: "2023-10-26T22:10:00Z",
    priority: "Medium",
    citizenName: "Ravi Shankar",
    issueArea: "Water Supply",
    category: "Infrastructure",
    imageUrl: "https://picsum.photos/seed/hydrant/800/600",
  },
  {
    id: "13",
    citizenId: "CZ-33445",
    title: "Request for New Park",
